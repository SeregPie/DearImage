...
(async () => {
	{
		...
		await DearImage.loadFontFace(fontFace, './fonts/Inconsolata/Bold.ttf');
		let image = DearImage.text('Hello World!', {
			fill: '',
			font: {...fontFace, size: 32},
			stroke: {
				style: '',
				width: 4,
			},
	...
	await DearImage.loadFontFace(fontFace, './fonts/Inconsolata/Regular.ttf');
